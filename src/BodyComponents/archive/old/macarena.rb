...
if __FILE__ == $0
  ...
  (0..1100).step(mStep) do |n|
    ...
    puts "----> Extreme frames distance: #{sum.min.to_s}"
    ...
    for i in 0..(index.length-1) do
      ...
      newW = 1/meanPointsDistance  * w
      puts "w, #{i.to_s},#{newW.to_s}"
      ...
      danceName = "Macarena Dance (CMU Motion Database)"
      scale     = 3
