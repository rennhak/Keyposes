...
if __FILE__ == $0
  ...
  stepsArray.each do |step|
    ...
    [ "xy", "yz" ].each do |direction|
      ...
      #(1200..3800).step( step ) do |n|
        ...
        points  = bc.getTurningPoints( "rank", "rkne", "lank", "lkne", "p30", direction, n, n+step) 
        #points  = bc.getTurningPoints( "p21", "p20", "p14", "p15", "p30", direction, rangeA, rangeB) 
  ...
  if( compete )
    ...
    distances.each do |array|
      ...
      points  = bc.getTurningPoints( "rank", "rkne", "lank", "lkne", "p30", "xy", a, b) 
      #points  = bc.getTurningPoints( "p21", "p20", "p14", "p15", "p30", direction, rangeA, rangeB) 
  ...
  (0..1100).step(mStep) do |n|
    ...
    points  = bc.getTurningPoints( "rank", "rkne", "lank", "lkne", "p30", direction, rangeA, rangeB) 
    #points  = bc.getTurningPoints( "p21", "p20", "p14", "p15", "p30", direction, rangeA, rangeB) 
    ...
    # HERE
    #points  = bc.getTurningPoints( "p27", "relb", "p26", "lelb", "p30", direction, rangeA, rangeB) 
    #
    points  = bc.getTurningPoints( "rank", "rkne", "lank", "lkne", "p30", direction, rangeA, rangeB) 
    index, x, y       = [], [], []
