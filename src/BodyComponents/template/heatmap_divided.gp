...
splot 'model_04/both/upper_arms/frenet_frame_kappa_plot.gpdata'  using 1:(1):2     w lines linestyle 2   ti '(1)  T-Data upper arms (Model 4)',\
      'model_08/both/upper_arms/frenet_frame_kappa_plot.gpdata'  using 1:(2):2     w lines linestyle 3   ti '(2)  T-Data upper arms (Model 8)',\
      'model_08/both/fore_arms/frenet_frame_kappa_plot.gpdata'   using 1:(3):2     w lines linestyle 4   ti '(3)  T-Data forearms (Model 8)',\
      'model_12/both/upper_arms/frenet_frame_kappa_plot.gpdata'  using 1:(4):2    w lines linestyle 5  ti '(4) T-Data upper arms (Model 12)',\
      'model_12/both/fore_arms/frenet_frame_kappa_plot.gpdata'   using 1:(5):2     w lines linestyle 6   ti '(5)  T-Data forearms (Model 12)',\
      'model_12/both/hands/frenet_frame_kappa_plot.gpdata'       using 1:(6):2     w lines linestyle 7   ti '(6)  T-Data hands (Model 12)',\
      'model_04/both/thighs/frenet_frame_kappa_plot.gpdata'      using 1:(7):2     w lines linestyle 8   ti '(7)  T-Data thighs (Model 4)',\
      'model_08/both/thighs/frenet_frame_kappa_plot.gpdata'      using 1:(8):2     w lines linestyle 9   ti '(8)  T-Data thighs (Model 8)',\
      'model_08/both/shanks/frenet_frame_kappa_plot.gpdata'      using 1:(9):2     w lines linestyle 10   ti '(9)  T-Data shanks (Model 8)',\
      'model_12/both/thighs/frenet_frame_kappa_plot.gpdata'      using 1:(10):2     w lines linestyle 11  ti '(10)  T-Data thighs (Model 12)',\
      'model_12/both/shanks/frenet_frame_kappa_plot.gpdata'      using 1:(11):2    w lines linestyle 12  ti '(11) T-Data shanks (Model 12)',\
      'model_12/both/feet/frenet_frame_kappa_plot.gpdata'        using 1:(12):2    w lines linestyle 13  ti '(12) T-Data feet (Model 12)',\
